...
class S {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    'log_login': {'ar': 'تسجيل الدخول', 'en': 'Logged in'},
    'log_created_order': {'ar': 'أنشأ طلبًا لـ', 'en': 'Created an order for'},
    'log_added_product': {'ar': 'أضاف منتج', 'en': 'Added product'},
    'log_updated_product': {'ar': 'عدّل منتج', 'en': 'Updated product'},
    'log_deleted_product': {'ar': 'حذف منتج', 'en': 'Deleted product'},
    'log_added_employee': {'ar': 'أضاف موظف', 'en': 'Added employee'},
    'log_updated_employee': {'ar': 'عدّل بيانات الموظف', 'en': 'Updated employee'},
    'log_deleted_employee': {'ar': 'حذف موظف', 'en': 'Deleted employee'},
    'log_deactivated_employee': {'ar': 'عطّل الموظف', 'en': 'Deactivated employee'},
    'log_activated_employee': {'ar': 'فعّل الموظف', 'en': 'Activated employee'},
    'log_clocked_in': {'ar': 'بدأ وردية عمل', 'en': 'Clocked in'},
    'log_clocked_out': {'ar': 'أنهى وردية عمل', 'en': 'Clocked out'},
    'log_added_expense': {'ar': 'أضاف مصروف', 'en': 'Added expense'},
    'log_deleted_expense': {'ar': 'حذف مصروف', 'en': 'Deleted expense'},
    'log_added_promo': {'ar': 'أضاف كود خصم', 'en': 'Added promo code'},
    'log_activated_promo': {'ar': 'فعّل كود الخصم', 'en': 'Activated promo code'},
    'log_deactivated_promo': {'ar': 'عطّل كود الخصم', 'en': 'Deactivated promo code'},
    'log_deleted_promo': {'ar': 'حذف كود خصم', 'en': 'Deleted promo code'},
